...
from crash_data_api._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: CrashDataAPI | AsyncCrashDataAPI) -> int:
...
class TestCrashDataAPI:
    client = CrashDataAPI(
        base_url=base_url, auth_token=auth_token, access_token=access_token, _strict_response_validation=True
    )
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "crash_data_api/_legacy_response.py",
                        "crash_data_api/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "crash_data_api/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: CrashDataAPI) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(CRASH_DATA_API_BASE_URL="http://localhost:5000/from/env"):
            client = CrashDataAPI(auth_token=auth_token, access_token=access_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: CrashDataAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: CrashDataAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: CrashDataAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = CrashDataAPI(
            base_url=base_url, auth_token=auth_token, access_token=access_token, _strict_response_validation=False
        )
    ...
    @mock.patch("crash_data_api._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/crash-data/aggregate").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/crash-data/aggregate").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v1/crash-data/aggregate").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: CrashDataAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncCrashDataAPI:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncCrashDataAPI) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(CRASH_DATA_API_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncCrashDataAPI(
                auth_token=auth_token, access_token=access_token, _strict_response_validation=True
            )
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncCrashDataAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncCrashDataAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncCrashDataAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncCrashDataAPI(
            base_url=base_url, auth_token=auth_token, access_token=access_token, _strict_response_validation=True
        )
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncCrashDataAPI,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.aggregated_crashes.with_raw_response.aggregate(
            distance_km=2,
            end_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            location={
                "lat": 24.396308,
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncCrashDataAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from crash_data_api._utils import asyncify
        from crash_data_api._base_client import get_platform 
