...
class TestCaTelematicsRiskScores:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_calculate(self, client: CrashDataAPI) -> None:
        ca_telematics_risk_score = client.ca_telematics_risk_scores.calculate(
    ...
    def test_raw_response_calculate(self, client: CrashDataAPI) -> None:
        response = client.ca_telematics_risk_scores.with_raw_response.calculate(
            policy_holder_id="policy-holder-123",
            vehicles=[
                {
                    "events": [
        ...
        ca_telematics_risk_score = response.parse()
        assert_matches_type(TelematicsRiskScoreResponse, ca_telematics_risk_score, path=["response"])

    @parametrize
    def test_streaming_response_calculate(self, client: CrashDataAPI) -> None:
        with client.ca_telematics_risk_scores.with_streaming_response.calculate(
            policy_holder_id="policy-holder-123",
            vehicles=[
                {
                    "events": [
...
class TestAsyncCaTelematicsRiskScores:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_calculate(self, async_client: AsyncCrashDataAPI) -> None:
        ca_telematics_risk_score = await async_client.ca_telematics_risk_scores.calculate(
            policy_holder_id="policy-holder-123",
            vehicles=[
                {
                    "events": [
    ...
    async def test_raw_response_calculate(self, async_client: AsyncCrashDataAPI) -> None:
        response = await async_client.ca_telematics_risk_scores.with_raw_response.calculate(
            policy_holder_id="policy-holder-123",
            vehicles=[
                {
                    "events": [
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        ca_telematics_risk_score = await response.parse()
        assert_matches_type(TelematicsRiskScoreResponse, ca_telematics_risk_score, path=["response"])

    @parametrize
    async def test_streaming_response_calculate(self, async_client: AsyncCrashDataAPI) -> None:
        async with async_client.ca_telematics_risk_scores.with_streaming_response.calculate(
            policy_holder_id="policy-holder-123",
            vehicles=[
                {
                    "events": [
