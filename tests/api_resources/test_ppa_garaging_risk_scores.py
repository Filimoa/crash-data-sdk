...
class TestPpaGaragingRiskScores:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_create(self, client: CrashDataAPI) -> None:
        ppa_garaging_risk_score = client.ppa_garaging_risk_scores.create(
    ...
    def test_raw_response_create(self, client: CrashDataAPI) -> None:
        response = client.ppa_garaging_risk_scores.with_raw_response.create(
            policy_holder_id="policy-holder-123",
            policy_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            vehicles=[
                {
        ...
        ppa_garaging_risk_score = response.parse()
        assert_matches_type(GaragingRiskScoreResponse, ppa_garaging_risk_score, path=["response"])

    @parametrize
    def test_streaming_response_create(self, client: CrashDataAPI) -> None:
        with client.ppa_garaging_risk_scores.with_streaming_response.create(
            policy_holder_id="policy-holder-123",
            policy_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            vehicles=[
                {
...
class TestAsyncPpaGaragingRiskScores:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_create(self, async_client: AsyncCrashDataAPI) -> None:
        ppa_garaging_risk_score = await async_client.ppa_garaging_risk_scores.create(
            policy_holder_id="policy-holder-123",
            policy_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            vehicles=[
                {
    ...
    async def test_raw_response_create(self, async_client: AsyncCrashDataAPI) -> None:
        response = await async_client.ppa_garaging_risk_scores.with_raw_response.create(
            policy_holder_id="policy-holder-123",
            policy_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            vehicles=[
                {
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        ppa_garaging_risk_score = await response.parse()
        assert_matches_type(GaragingRiskScoreResponse, ppa_garaging_risk_score, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncCrashDataAPI) -> None:
        async with async_client.ppa_garaging_risk_scores.with_streaming_response.create(
            policy_holder_id="policy-holder-123",
            policy_start=parse_datetime("2019-12-27T18:11:19.117Z"),
            vehicles=[
                {
