...
class TestBatch:
    ...
    def test_method_results(self, client: CrashDataAPI) -> None:
        batch = client.ca_garaging_risk_scores.batch.results(
            "job_id",
        )
    ...
    def test_raw_response_results(self, client: CrashDataAPI) -> None:
        response = client.ca_garaging_risk_scores.batch.with_raw_response.results(
            "job_id",
        )
    ...
    def test_streaming_response_results(self, client: CrashDataAPI) -> None:
        with client.ca_garaging_risk_scores.batch.with_streaming_response.results(
            "job_id",
        ) as response:
    ...
    def test_path_params_results(self, client: CrashDataAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.ca_garaging_risk_scores.batch.with_raw_response.results(
                "",
            )

    @parametrize
    def test_method_status(self, client: CrashDataAPI) -> None:
        batch = client.ca_garaging_risk_scores.batch.status(
            "job_id",
        )
    ...
    def test_raw_response_status(self, client: CrashDataAPI) -> None:
        response = client.ca_garaging_risk_scores.batch.with_raw_response.status(
            "job_id",
        )
    ...
    def test_streaming_response_status(self, client: CrashDataAPI) -> None:
        with client.ca_garaging_risk_scores.batch.with_streaming_response.status(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_status(self, client: CrashDataAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.ca_garaging_risk_scores.batch.with_raw_response.status(
                "",
            )

    @parametrize
    def test_method_submit(self, client: CrashDataAPI) -> None:
        batch = client.ca_garaging_risk_scores.batch.submit(
            body=[
                {
    ...
    def test_raw_response_submit(self, client: CrashDataAPI) -> None:
        response = client.ca_garaging_risk_scores.batch.with_raw_response.submit(
            body=[
                {
                    "policy_holder_id": "policy-holder-123",
                    "policy_start": parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    def test_streaming_response_submit(self, client: CrashDataAPI) -> None:
        with client.ca_garaging_risk_scores.batch.with_streaming_response.submit(
            body=[
                {
                    "policy_holder_id": "policy-holder-123",
                    "policy_start": parse_datetime("2019-12-27T18:11:19.117Z"),
...
class TestAsyncBatch:
    ...
    async def test_method_results(self, async_client: AsyncCrashDataAPI) -> None:
        batch = await async_client.ca_garaging_risk_scores.batch.results(
            "job_id",
        )
        assert_matches_type(BatchResultsResponse, batch, path=["response"])
    ...
    async def test_raw_response_results(self, async_client: AsyncCrashDataAPI) -> None:
        response = await async_client.ca_garaging_risk_scores.batch.with_raw_response.results(
            "job_id",
        )
    ...
    async def test_streaming_response_results(self, async_client: AsyncCrashDataAPI) -> None:
        async with async_client.ca_garaging_risk_scores.batch.with_streaming_response.results(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_results(self, async_client: AsyncCrashDataAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.ca_garaging_risk_scores.batch.with_raw_response.results(
                "",
            )

    @parametrize
    async def test_method_status(self, async_client: AsyncCrashDataAPI) -> None:
        batch = await async_client.ca_garaging_risk_scores.batch.status(
            "job_id",
        )
        assert_matches_type(BatchJobStatus, batch, path=["response"])
    ...
    async def test_raw_response_status(self, async_client: AsyncCrashDataAPI) -> None:
        response = await async_client.ca_garaging_risk_scores.batch.with_raw_response.status(
            "job_id",
        )
    ...
    async def test_streaming_response_status(self, async_client: AsyncCrashDataAPI) -> None:
        async with async_client.ca_garaging_risk_scores.batch.with_streaming_response.status(
            "job_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_status(self, async_client: AsyncCrashDataAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.ca_garaging_risk_scores.batch.with_raw_response.status(
                "",
            )

    @parametrize
    async def test_method_submit(self, async_client: AsyncCrashDataAPI) -> None:
        batch = await async_client.ca_garaging_risk_scores.batch.submit(
            body=[
                {
                    "policy_holder_id": "policy-holder-123",
                    "policy_start": parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    async def test_raw_response_submit(self, async_client: AsyncCrashDataAPI) -> None:
        response = await async_client.ca_garaging_risk_scores.batch.with_raw_response.submit(
            body=[
                {
                    "policy_holder_id": "policy-holder-123",
                    "policy_start": parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    async def test_streaming_response_submit(self, async_client: AsyncCrashDataAPI) -> None:
        async with async_client.ca_garaging_risk_scores.batch.with_streaming_response.submit(
            body=[
                {
                    "policy_holder_id": "policy-holder-123",
                    "policy_start": parse_datetime("2019-12-27T18:11:19.117Z"),
