...
from ...types.ppa_garaging_risk_scores import batch_create_params
from ...types.ppa_garaging_risk_scores.batch_results_response import BatchResultsResponse
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/v1/risk-score/ppa-garaging/batch",
    ...
    def results(
        ...
        *,
        ...
        return self._get(
            f"/v1/risk-score/ppa-garaging/batch/{job_id}/results",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def status(
        ...
        *,
        ...
        if not job_id:
            raise ValueError(f"Expected a non-empty value for `job_id` but received {job_id!r}")
        return self._get(
            f"/v1/risk-score/ppa-garaging/batch/{job_id}/status",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchJobStatus,
