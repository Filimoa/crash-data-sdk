...
from ...types.shared.batch_job_status import BatchJobStatus
from ...types.ppa_telematics_risk_scores import batch_create_params
from ...types.ppa_telematics_risk_scores.batch_results_response import BatchResultsResponse
...
class BatchResource(SyncAPIResource):
    ...
    def create(
        self,
        *,
        body: Iterable[batch_create_params.Body],
        ...
        """
        Submit many requests at once for batch processing.
        ...
        """
        return self._post(
            "/v1/risk-score/ppa-telematics/batch",
            body=maybe_transform(body, Iterable[batch_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchJobStatus,
        )
    ...
    def results(
        ...
        *,
        ...
        return self._get(
            f"/v1/risk-score/ppa-telematics/batch/{job_id}/results",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchResultsResponse,
        )
    ...
    def status(
        ...
        *,
        ...
        if not job_id:
            raise ValueError(f"Expected a non-empty value for `job_id` but received {job_id!r}")
        return self._get(
            f"/v1/risk-score/ppa-telematics/batch/{job_id}/status",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchJobStatus,
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/v1/risk-score/ppa-telematics/batch",
            body=await async_maybe_transform(body, Iterable[batch_create_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchJobStatus,
